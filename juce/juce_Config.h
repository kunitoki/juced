...
/** Comment out this macro to disable building of LASH support on Linux.
*/
#ifndef JUCE_LASH
//  #define JUCE_LASH 1
#endif
...
/** Disabling this will avoid linking to any extended classes, namely from
...
//  #define JUCE_SUPPORT_SCRIPTING 1
#endif
...
/** These flags are for JUCETICE direct inclusion of 3rd-party libs in the
    codebase - you might need to use this if you're linking to some of these libraries
    yourself.
*/
