...
public:
    ...
    StandaloneFilterWindow (const String& title,
                            ...
                            const int requiredButtons = DocumentWindow::allButtons,
                            const bool optionsButtonVisible = false,
                            const String& commandLine = String::empty);
    ...
    */
    ...
    //==============================================================================
    /** Returns the actual filter displayed inside the window */
    AudioProcessor* getFilter ()                            { return filter; }

    /** Returns the currently used audio io device */ 
