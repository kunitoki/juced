...
ifeq ($(CONFIG),Debug)
  BINDIR := ../../../../../bin
  LIBDIR := ../../../../../bin
  OBJDIR := ../../../../../bin/intermediate/FontSerialiserDebug
  OUTDIR := ../../../../../bin
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -L"/usr/X11R6/lib/" -lfreetype -lpthread -lrt -lX11 -lXrender -lXi -lGL -lGLU -lXinerama -lasound
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "DEBUG=1" -D "_DEBUG=1" -I "/usr/include" -I "/usr/include/freetype2"
  TARGET := fontserialiser
...
ifeq ($(CONFIG),Release)
  BINDIR := ../../../../../bin
  LIBDIR := ../../../../../bin
  OBJDIR := ../../../../../bin/intermediate/FontSerialiserRelease
  OUTDIR := ../../../../../bin
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "NDEBUG=1" -I "/usr/include" -I "/usr/include/freetype2"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -O2
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -s -L"/usr/X11R6/lib/" -lfreetype -lpthread -lrt -lX11 -lXrender -lXi -lGL -lGLU -lXinerama -lasound
  LDDEPS :=
...
$(OBJDIR)/FontSerialiser.o: ../../FontSerialiser.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
