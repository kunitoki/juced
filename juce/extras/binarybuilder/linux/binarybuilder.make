...
ifeq ($(CONFIG),Debug)
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -L"/usr/X11R6/lib/" -L"../../../../bin" -lpthread -lrt
  LDDEPS :=
...
ifeq ($(CONFIG),Release)
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -s -L"/usr/X11R6/lib/" -L"../../../../bin" -lpthread -lrt
  LDDEPS :=
...
$(OBJDIR)/BinaryBuilder.o: ../BinaryBuilder.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
