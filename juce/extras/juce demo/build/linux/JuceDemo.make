...
ifeq ($(CONFIG),Debug)
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -mwindows -L"/usr/X11R6/lib/" -L"../../../../bin" -lfreetype -lpthread -lrt -lX11 -lXrender -lXi -lGL -lGLU -lXinerama -lasound
  LDDEPS :=
...
ifeq ($(CONFIG),Release)
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -mwindows -s -L"/usr/X11R6/lib/" -L"../../../../bin" -lfreetype -lpthread -lrt -lX11 -lXrender -lXi -lGL -lGLU -lXinerama -lasound
  LDDEPS :=
