...
#include "jucetice_MADAudioFormat.h"
...
//==============================================================================
static const tchar* const mad_extensions[] =    { T(".mp3"), T(".mp2"), T(".mpg"), 0 };

MADAudioFormat::MADAudioFormat()
    : AudioFormat(T("MPEG Audio Decoder (MAD)"), (const tchar**) mad_extensions)
{
}
