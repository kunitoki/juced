...
XmlElement* CoordinateSystem::getStateAsXml(const String& stateName) const
{
 ...
 xmlState->setAttribute(String(T("MinX")), range.getMinX());
 xmlState->setAttribute(String(T("MaxX")), range.getMaxX());
 xmlState->setAttribute(String(T("MinY")), range.getMinY());
 xmlState->setAttribute(String(T("MaxY")), range.getMaxY());
...
bool CoordinateSystem::setStateFromXml(const XmlElement &xmlState)
{
 ...
 range.setMinX( xmlState.getDoubleAttribute(String(T("MinX")),getMinX()) );
 range.setMaxX( xmlState.getDoubleAttribute(String(T("MaxX")),getMaxX()) );
 range.setMinY( xmlState.getDoubleAttribute(String(T("MinY")),getMinY()) );
 range.setMaxY( xmlState.getDoubleAttribute(String(T("MaxY")),getMaxY()) );
