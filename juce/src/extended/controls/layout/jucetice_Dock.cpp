...
void Dock::itemDragEnter (const String& sourceDescription,
...
void Dock::itemDragMove (const String& sourceDescription,
                         Component* sourceComponent,
                         int x, int y)
{
}

void Dock::itemDragExit (const String& sourceDescription,
                         Component* sourceComponent)
{
    somethingIsBeingDraggedOver = false;
    repaint();
...
void Dock::itemDropped (const String& sourceDescription,
                        Component* sourceComponent,
                        int x, int y)
{
    ...
    Component* targetComponent = getComponentAt (x, y);

    if (findComponent (sourceComponent, sourcePanelIndex, sourcePanelSubIndex)
