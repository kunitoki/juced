...
*/
#define JucePlugin_Name                     "SoundCrab"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "SoundFont2 player"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'jsc0'
...
/** A version number
*/
#define JucePlugin_VersionCode              0x00000204

#define JucePlugin_VersionString            "0.2.4"
