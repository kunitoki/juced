...
#ifndef __JUCETICE_SOUNDCRABEDITOR_HEADER__
#define __JUCETICE_SOUNDCRABEDITOR_HEADER__

#include "SoundCrabPlugin.h"
#include "Components/SoundCrabMainComponent.h"
#include "Components/SoundCrabAboutComponent.h"
...
*/
class SoundCrabEditor  : public AudioProcessorEditor,
...
public:
    ...
    */
    SoundCrabEditor (SoundCrabPlugin* const ownerFilter);
    ...
    */
    ...
    SoundCrabPlugin* getFilter() const throw() { return (SoundCrabPlugin*) getAudioProcessor(); }

private:

    //==============================================================================
    friend class SoundCrabPlugin;

    TabbedComponent* tabComponent;
    SoundCrabMainComponent* mainComponent;
    SoundCrabAboutComponent* aboutComponent;

    TooltipWindow tooltipWindow;
};


#endif // __JUCETICE_SOUNDCRABEDITOR_HEADER__
