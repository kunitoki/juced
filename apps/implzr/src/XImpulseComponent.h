...
#ifndef __JUCETICE_XIMPLZRCOMPONENT_HEADER__
#define __JUCETICE_XIMPLZRCOMPONENT_HEADER__

#include "XImpulsePlugin.h"
#include "Components/XImpulseMainComponent.h"
...
*/
class XImpulseComponent  : public AudioProcessorEditor,
...
public:
    ...
    */
    XImpulseComponent (XImpulsePlugin* const ownerFilter);
...
private:
    ...
    //==============================================================================
    friend class XImpulsePlugin;

    TooltipWindow tooltipWindow;
    
    XImpulseMainComponent* mainComponent;

    // handy wrapper method to avoid having to cast the filter to a DemoJuceFilter
    // every time we need it..
    XImpulsePlugin* getFilter() const throw()  { return (XImpulsePlugin*) getAudioProcessor(); }
};
