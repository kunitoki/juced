...
#ifndef __JUCETICE_PEGGY2000_SLIDERFIELDCOMPONENT_HEADER__
#define __JUCETICE_PEGGY2000_SLIDERFIELDCOMPONENT_HEADER__
...
public:
    ...
    SliderFieldComponent()
        : Component (T("Slider Field Component"))
    {
        array = new float[16];
    ...
    void reset()
    {
        zeromem (array, numSliders * sizeof (float));
        repaint();
    }
