...
#ifndef __JUCETICE_XSYNTHMULTIEQGRAPH_HEADER__
#define __JUCETICE_XSYNTHMULTIEQGRAPH_HEADER__

#include "../../StandardHeader.h"
#include "../../../../capsaicin/src/Misc/Util.h"
...
public:
    ...
    EQGraph ()
      : eff (0),
        ...
        fillColour (Colours::white.withAlpha (0.75f)),
