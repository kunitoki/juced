...
#ifndef __JUCETICE_XCOMPCOMPONENT_H
#define __JUCETICE_XCOMPCOMPONENT_H

#include "XCompPlugin.h"
//#include "Components/XCompTabPanel.h"
#include "Components/XCompMain.h"

#include "Components/Utils/MultipleEQGraph.h"
...
*/
class XCompComponent  : public AudioProcessorEditor,
...
public:
    ...
    */
    XCompComponent (XCompPlugin* const ownerFilter);
...
private:
    ...
    //==============================================================================
    friend class XCompPlugin;

    // XEQTabPanel* tabComponent;
    XCompMain* mainComponent;
    ...
    XCompPlugin* getFilter() const throw()  { return (XCompPlugin*) getAudioProcessor(); }
};
