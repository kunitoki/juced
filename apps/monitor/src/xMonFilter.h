...
#ifndef __JUCETICE_XMONITORFILTER_HEADER__
#define __JUCETICE_XMONITORFILTER_HEADER__
...
public:
	...
	// The incoming midi messages are kept here
	MidiBuffer	incomingMidiMessages;
