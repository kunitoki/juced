...
#ifndef __JUCETICE_XDUBDELAYCOMPONENT_HEADER__
#define __JUCETICE_XDUBDELAYCOMPONENT_HEADER__

#include "XDubDelayPlugin.h"
#include "Components/XDubDelayMainComponent.h"
...
*/
class XDubDelayComponent  : public AudioProcessorEditor,
...
public:
    ...
    */
    XDubDelayComponent (XDubDelayPlugin* const ownerFilter);
...
private:
    ...
    //==============================================================================
    friend class XDubDelayPlugin;

    TooltipWindow tooltipWindow;
    
    XDubDelayMainComponent* mainComponent;

    // handy wrapper method to avoid having to cast the filter to a DemoJuceFilter
    // every time we need it..
    XDubDelayPlugin* getFilter() const throw()  { return (XDubDelayPlugin*) getAudioProcessor(); }
};
