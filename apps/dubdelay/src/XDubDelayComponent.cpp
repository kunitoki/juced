...
//==============================================================================
XDubDelayComponent::XDubDelayComponent (XDubDelayPlugin* const ownerFilter_)
...
//    getFilter()->addListenerToParameters (this);
    ...
    addAndMakeVisible (mainComponent = new XDubDelayMainComponent (this,
                                                                  getFilter ()));
...
XDubDelayComponent::~XDubDelayComponent()
{
    deleteAllChildren();
...
//==============================================================================
void XDubDelayComponent::resized()
{
    mainComponent->setBounds (0, 0, getWidth(), getHeight());
}

//==============================================================================
void XDubDelayComponent::paint (Graphics& g)
{
    g.fillAll (Colour (64, 64, 64));
}

//==============================================================================
void XDubDelayComponent::changeListenerCallback (void* source)
{
    if (source == getFilter())
    {
...
//==============================================================================
void XDubDelayComponent::parameterChanged (AudioParameter* parameter, const int indexr)
{
