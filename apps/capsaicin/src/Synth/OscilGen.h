...
#ifndef __JUCETICE_XSYNTHOSCILGEN_HEADER__
#define __JUCETICE_XSYNTHOSCILGEN_HEADER__
...
public:
    ...
    void prepare();
    void setToPrepare() { oscilprepared = 0; }
    ...
    */
    ...
    static FFTFrequencies outoscilFFTfreqs;
...
private:
    ...
    FFTWrapper *fft;
    void changebasefunction();  // Computes the basefunction and make the FFT; newbasefunc<0  = same basefunc
    void waveshape();           // Waveshaping
    ...
    void adaptiveharmonic(FFTFrequencies f,REALTYPE freq);
    ...
    FFTFrequencies basefuncFFTfreqs;//Base Function Frequencies
    FFTFrequencies oscilFFTfreqs;//Oscillator Frequencies - this is different than the hamonics set-up by the user, it may contains time-domain data if the antialiasing is turned off
