...
#ifndef __JUCETICE_XSYNTHADNOTEPARAMETERS_HEADER__
#define __JUCETICE_XSYNTHADNOTEPARAMETERS_HEADER__
...
private:
    ...
    void addToXMLSection (XmlElement* xml, int n);
    void updateFromXMLSection (XmlElement *xml, int n);
};
