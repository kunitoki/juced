...
//==============================================================================
void Reverb::processMono (int ch, REALTYPE *output, const int numSamples)
{
    int i, j;
    REALTYPE fbout, tmp;
...
//==============================================================================
void Reverb::out (REALTYPE *smps_l, REALTYPE *smps_r, const int numSamples)
{
    int i;
...
//==============================================================================
void Reverb::setParameter (int npar, uint8 value)
{
    switch (npar)
    {
...
uint8 Reverb::getParameter (int npar)
{
    switch (npar){
...
//==============================================================================
void Reverb::setvolume (uint8 Pvolume)
{
...
void Reverb::setpan (uint8 Ppan)
{
    this->Ppan = Ppan;
    pan = (REALTYPE) Ppan / 127.0;
}

void Reverb::settime (uint8 Ptime)
{
    int i;
    REALTYPE t;
    this->Ptime = Ptime;
...
void Reverb::setlohidamp (uint8 Plohidamp)
{
    REALTYPE x;
...
void Reverb::setidelay (uint8 Pidelay){
    REALTYPE delay;
...
void Reverb::setidelayfb (uint8 Pidelayfb)
{
    this->Pidelayfb=Pidelayfb;
    idelayfb=Pidelayfb/128.0;
}

void Reverb::sethpf (uint8 Phpf)
{
    this->Phpf=Phpf;
    if (Phpf==0)
    {
...
void Reverb::settype (uint8 Ptype)
{
...
void Reverb::setroomsize (uint8 Proomsize)
{
...
//==============================================================================
void Reverb::setPreset (uint8 npreset)
{
