...
//==============================================================================
void Phaser::out (REALTYPE *smpsl, REALTYPE *smpsr, const int numSamples)
{
    int i,j;
...
//==============================================================================
void Phaser::setParameter (int npar, uint8 value)
{
    switch(npar)
    {
...
uint8 Phaser::getParameter (int npar)
{
    switch (npar)
    {
    ...
    case 8:  return(Pstages);          break;
    case 9:  return(Plrcross);         break;
    case 10: return(Poutsub);          break;
    case 11: return(Pphase);           break;
    default: return (0);
    }
}

//==============================================================================
void Phaser::setdepth (uint8 Pdepth)
{
    this->Pdepth=Pdepth;
    depth=(Pdepth/127.0);
}

void Phaser::setfb (uint8 Pfb)
{
    this->Pfb=Pfb;
    fb=(Pfb-64.0)/64.1;
}

void Phaser::setvolume (uint8 Pvolume)
{
...
void Phaser::setpanning (uint8 Ppanning)
{
    this->Ppanning=Ppanning;
    panning=Ppanning/127.0;
}

void Phaser::setlrcross (uint8 Plrcross)
{
    this->Plrcross=Plrcross;
    lrcross=Plrcross/127.0;
}

void Phaser::setstages (uint8 Pstages)
{
    if (oldl!=NULL) delete [] oldl;
    if (oldr!=NULL) delete [] oldr;
...
void Phaser::setphase (uint8 Pphase)
{
    this->Pphase=Pphase;
    phase=(Pphase/127.0);
}
...
//==============================================================================
void Phaser::setPreset (uint8 npreset)
{
