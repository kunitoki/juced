...
*/
#define JucePlugin_Name                     "Jost"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "Multi Host 4 Linux"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'jost'
...
/** A version number
*/
#define JucePlugin_VersionCode              0x00000505

#define JucePlugin_VersionString            "0.5.5"
