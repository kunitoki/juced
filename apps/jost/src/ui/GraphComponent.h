...
#ifndef __JUCETICE_JOSTGRAPHCOMPONENT_HEADER__
#define __JUCETICE_JOSTGRAPHCOMPONENT_HEADER__
...
*/
class GraphComponentSelectedModules   : public SelectedItemSet<GraphNodeComponent*>
{
public:
...
public:
    ...
    //==============================================================================
    GraphComponent (HostFilterComponent* owner_);
...
//                                          const int connectorType,
    ...
    GraphComponentSelectedModules selectedNodes;
