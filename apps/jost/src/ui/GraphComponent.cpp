...
//==============================================================================
void GraphComponentSelectedModules::itemSelected (GraphNodeComponent* item)
{
    item->repaint ();
}

void GraphComponentSelectedModules::itemDeselected (GraphNodeComponent* item)
{
    item->repaint ();
}
...
//==============================================================================
bool GraphComponent::isInterestedInFileDrag (const StringArray&)
{
    return true;
}

void GraphComponent::filesDropped (const StringArray& filenames,
                                   int mouseX,
                                   int mouseY)
{
    if (filenames.size())
...
void GraphComponent::nodeDoubleClicked (GraphNodeComponent* node,
                                        const MouseEvent& e)
{
    DBG ("GraphComponent::nodeDoubleClicked");
...
Colour GraphComponent::getConnectorColour (GraphConnectorComponent* connector, const bool isSelected)
{
    jassert (connector != 0);
...
//==============================================================================
void GraphComponent::setHost (Host* hostToDisplay)
{
    DBG ("GraphComponent::setHost");
...
//==============================================================================
bool GraphComponent::dropPluginOnTrack (const File& pluginFile,
                                        int mouseX,
                                        int mouseY)
{
...
bool GraphComponent::closeAllPlugins ()
{
    DBG ("GraphComponent::closeAllPlugins");
...
int GraphComponent::getPluginsCount () const
{
    return nodes.size ();
}
...
bool GraphComponent::deletePluginNode (GraphNodeComponent* node)
{
    if (node)
    {
...
void GraphComponent::cleanInternalGraph ()
{
    DBG ("GraphComponent::cleanInternalGraph < " + String (getNumChildComponents()));
...
SelectedItemSet<GraphNodeComponent*>& GraphComponent::getLassoSelection ()
{
...
//==============================================================================
bool GraphComponent::isInterestedInDragSource (const String& sourceDescription,
                                               Component* /*source*/)
{
...
void GraphComponent::itemDragEnter (const String& sourceDescription,
...
void GraphComponent::itemDragMove (const String& sourceDescription,
                                   Component* sourceComponent,
                                   int x, int y)
{
}

void GraphComponent::itemDragExit (const String& sourceDescription,
                                   Component* sourceComponent)
{
    somethingIsBeingDraggedOver = false;
    repaint();
