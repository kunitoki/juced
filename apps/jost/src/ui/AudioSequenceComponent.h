...
#ifndef __JUCETICE_JOSTAUDIOSEQUENCECOMPONENT_HEADER__
#define __JUCETICE_JOSTAUDIOSEQUENCECOMPONENT_HEADER__
...
/**
     An track component
*/
class AudioSequenceComponent  : public Component,
                                public Dockable,
...
public:
    ...
    //==============================================================================
    AudioSequenceComponent (HostFilterComponent* owner_);
    ...
    */
    void setSequence (SequenceAudioSource* sequenceToDisplay);
...
protected:
    ...
    int getEventIndexFromMousePosition (const int x, const int y) const;

    HostFilterComponent* owner;
    SequenceAudioSource* sequence;

    float currentZoom;
    int selectedEvent;
    int draggingEventIndex;
};
