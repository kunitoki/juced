...
ifeq ($(CONFIG),Debug)
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -shared -L"../../../../bin" -L"/usr/X11R6/lib/" -L"/usr/lib/" -lfreetype -lpthread -lrt -ldl -lX11 -lXext -ljuce_debug
  LDDEPS :=
...
ifeq ($(CONFIG),Release)
  ...
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -shared -s -L"../../../../bin" -L"/usr/X11R6/lib/" -L"/usr/lib/" -lfreetype -lpthread -lrt -ldl -lX11 -lXext -ljuce
  LDDEPS :=
